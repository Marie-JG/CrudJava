...
public class Paciente {
    ...
    public Paciente(String nombre, String apellido, String mail, String fechaNacimiento) {
        this(0, nombre, apellido, mail, fechaNacimiento, "");
    }

    public Paciente(int id, String nombre, String apellido, String mail, String fechaNacimiento) {
        this(id, nombre, apellido, mail, fechaNacimiento, "");
    }

    public Paciente(int id, String nombre, String apellido, String mail, String fechaNacimiento, String foto) {
        setId(id);
